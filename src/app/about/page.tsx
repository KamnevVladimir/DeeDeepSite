          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-white/80 mb-6 apple-body">
                Мы верим, что управление долгами должно быть простым, интуитивным и доступным каждому. 
                DeeDeep объединяет передовые технологии ИИ с элегантным дизайном, чтобы создать 
                лучший опыт управления личными финансами.
              </p>
              <p className="text-lg text-white/80 apple-body">
                Наша команда состоит из экспертов в области машинного обучения, дизайна и финансов, 
                которые работают над тем, чтобы сделать управление долгами максимально удобным.
              </p>
            </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                name: "Дмитрий Козлов",
                role: "Head of Design",
                bio: "Создает пользовательский опыт уровня Apple и Google",
                avatar: "🎨"
              }
            ].map((member, index) => (
              <motion.div
